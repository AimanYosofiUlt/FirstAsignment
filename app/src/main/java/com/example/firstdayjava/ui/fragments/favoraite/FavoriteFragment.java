...
import com.example.firstdayjava.databinding.FragmentFavoriteBinding;
...
public class FavoriteFragment extends Fragment {
    FragmentFavoriteBinding bd;
    @Inject
    FavoriteFragmentViewModel viewModel;
    ...
    private void initViewModel() {
        viewModel.favoriteDataLiveData.observe(getViewLifecycleOwner(), dataList -> adapter.setList(dataList));
    }
